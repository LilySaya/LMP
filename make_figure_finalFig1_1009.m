...
ylabel('Prosumption [GW]','Fontname','Times','FontSize',18);
plot(1:n,Agg(aggNo).load,'k-o','Linewidth',2,'MarkerFaceColor','k','MarkerSize',8);%Load[GW]
plot(1:n,-x_giv{aggNo},'bs-','Linewidth',2,'MarkerFaceColor','b','MarkerSize',8);%Prosumption[GW]
for ii=1:10;
    plot(1:n,Agg(aggNo).hpv{ii},'-','Color',koike(ii,:),'Linewidth',0.5);%PV_scenarios[GW]
    plot(1:n,Agg(aggNo).hpv{ii}-q{aggNo}{ii},'*-','Color',koike(ii,:),'Linewidth',1,'MarkerSize',8);%PV_used[GW]
end
ylim([-2 8.5]);
...
%title(sprintf('Agg%d, PVlevel:%d Batterylevel:%d',aggNo,PVlevel,batterylevel))
xlabel('Time [h]','Fontname','Times','FontSize',18);
ylabel('Charge and discharge [GW]','Fontname','Times','FontSize',18);
for ii=1:10;
    plot(1:n,delta{aggNo}{ii},'*-','Color',koike(ii,:),'Linewidth',2,'MarkerSize',8);%C/D power
end
ylim([-2 3]);
%--- Fig.1(a3) ------------------------------------------------------------
...
%title(sprintf('Agg%d, PVlevel:%d Batterylevel:%d',aggNo,PVlevel,batterylevel))
xlabel('Time [h]','Fontname','Times','FontSize',18);
ylabel('SOC [GWh]','Fontname','Times','FontSize',18);
for ii=1:10;
    plot(0:1:n,[0;yaa{aggNo}{ii}],'*-','Color',koike(ii,:),'Linewidth',2,'MarkerSize',8);%SOC
end
...
title(sprintf('Agg%d, PVlevel:%d Batterylevel:%d',aggNo,PVlevel,batterylevel))
xlabel('Time [h]','Fontname','Times','FontSize',18);
ylabel('power generation [GWh]','Fontname','Times','FontSize',18);
for ii=1:10;
    plot(1:n,g01{aggNo}{ii}+g02{aggNo}{ii}+g03{aggNo}{ii}+...
             g04{aggNo}{ii}+g05{aggNo}{ii}+g06{aggNo}{ii}+...
             g07{aggNo}{ii}+g08{aggNo}{ii}+g09{aggNo}{ii}+...
             g10{aggNo}{ii}+g11{aggNo}{ii}+g12{aggNo}{ii}+...
             g13{aggNo}{ii},'*-','Color',koike(ii,:),'Linewidth',2,'MarkerSize',8);%SOC
end
ylim([-2 6])
