...
profit1=-cost1...
        +(lam-...
        cprice_max1+...
        cprice_min1)'*x_agg1_nodal1;%Profit for Agg.#1
lmp1= (lam-...
        cprice_max1+...
        cprice_min1);
Sum_lmp1 = sum(lmp1)
MCC1 = -cprice_max1+cprice_min1
%**************************************************************************
%*** Profit for Agg.#2 ****************************************************
%**************************************************************************
%{
...
profit3=-cost3...
        +(lam-...
        cprice_max3+...
        cprice_min3)'*x_agg3_nodal3;%Profit for Agg.#3
lmp3=(lam-...
        cprice_max3+...
        cprice_min3);
Sum_lmp3 = sum(lmp3)
MCC3 = -cprice_max3+cprice_min3
%**************************************************************************
%*** Profit for Agg.#4 ****************************************************
%**************************************************************************
%{
...
profit4=-cost4...
        +(lam-...
        cprice_max4+...
        cprice_min4)'*x_agg4_nodal4;%Profit for Agg.#4
lmp4=(lam-...
        cprice_max4+...
        cprice_min4);
Sum_lmp4 = sum(lmp4)
MCC4 = -cprice_max4+cprice_min4
%**************************************************************************
%*** Profit for Agg.#5 ****************************************************
%**************************************************************************
%{
...
profit5=-cost5...
        +(lam-...
        cprice_max5+...
        cprice_min5)'*x_agg5_nodal5;%Profit for Agg.#5
lmp5=(lam-...
        cprice_max5+...
        cprice_min5);
Sum_lmp5 = sum(lmp5)
MCC5 = -cprice_max5+cprice_min5
...
LMP_total = [Sum_lmp1, Sum_lmp2, Sum_lmp3, Sum_lmp4, Sum_lmp5]
